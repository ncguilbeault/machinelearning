...
/// </summary>
/// <remarks>
/// See <see href="https://pytorch.org/docs/stable/generated/torch.nn.Dropout2d.html"/> for more information.
/// </remarks>
...
public class Dropout2D
{
    ...
    /// </summary>
    /// <returns></returns>
    public IObservable<TorchSharp.Modules.Dropout2d> Process()
    {
    ...
    /// <returns></returns>
    public IObservable<TorchSharp.Modules.Dropout2d> Process<T>(IObservable<T> source)
    {
