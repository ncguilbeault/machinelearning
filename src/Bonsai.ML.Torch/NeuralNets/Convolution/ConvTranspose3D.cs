...
/// </summary>
/// <remarks>
/// See <see href="https://pytorch.org/docs/stable/generated/torch.nn.ConvTranspose3d.html"/> for more information.
/// </remarks>
...
public class ConvTranspose3D
{
    ...
    /// </summary>
    /// <returns></returns>
    public IObservable<TorchSharp.Modules.ConvTranspose3d> Process()
    {
    ...
    /// <returns></returns>
    public IObservable<TorchSharp.Modules.ConvTranspose3d> Process<T>(IObservable<T> source)
    {
