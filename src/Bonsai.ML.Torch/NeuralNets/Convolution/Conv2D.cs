...
/// </summary>
/// <remarks>
/// See <see href="https://pytorch.org/docs/stable/generated/torch.nn.Conv2d.html"/> for more information.
/// </remarks>
...
public class Conv2D
{
    ...
    /// </summary>
    /// <returns></returns>
    public IObservable<TorchSharp.Modules.Conv2d> Process()
    {
    ...
    /// <returns></returns>
    public IObservable<TorchSharp.Modules.Conv2d> Process<T>(IObservable<T> source)
    {
