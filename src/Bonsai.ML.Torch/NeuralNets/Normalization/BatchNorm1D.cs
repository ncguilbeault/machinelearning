...
/// <summary>
/// Represents an operator that creates a 1D batch normalization module.
/// </summary>
/// <remarks>
/// See <see href="https://pytorch.org/docs/stable/generated/torch.nn.BatchNorm1d.html"/> for more information.
/// </remarks>
[Description("Creates a 1D batch normalization module.")]
public class BatchNorm1D
{
    /// <summary>
    /// The number of features or channels of the input.
    /// </summary>
    [Description("The number of features or channels of the input.")]
