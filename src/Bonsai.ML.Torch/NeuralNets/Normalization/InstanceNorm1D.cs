...
/// <summary>
/// Represents an operator that creates a 1d instance normalization module.
/// </summary>
/// <remarks>
/// See <see href="https://pytorch.org/docs/stable/generated/torch.nn.InstanceNorm1d.html"/> for more information.
/// </remarks>
...
public class InstanceNorm1D
{
    ...
    /// </summary>
    [Description("The number of features or channels in the input tensor.")]
    ...
    /// <summary>
    /// Creates an InstanceNorm1d module.
    /// </summary>
    /// <returns></returns>
    public IObservable<TorchSharp.Modules.InstanceNorm1d> Process()
    {
    ...
    /// <returns></returns>
    public IObservable<TorchSharp.Modules.InstanceNorm1d> Process<T>(IObservable<T> source)
    {
        return source.Select(_ => InstanceNorm1d(Features, Eps, Momentum, Affine, TrackRunningStats, Device, Type));
    }
}
